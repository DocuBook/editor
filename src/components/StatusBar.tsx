...
export default function StatusBar() {
  ...
  return (
    <footer className="h-6 bg-[var(--bg-secondary)] border-t border-[var(--border-subtle)] flex items-center text-xs text-zinc-600 shrink-0" style={{ padding: '0 12px 0 8px' }}>
