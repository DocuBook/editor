  ...
  return (
    <div className="h-screen flex items-center justify-center p-8">
      <div className="w-full max-w-[320px]">
        ...
        <div className="text-xs text-[var(--text-muted)] mt-1 mb-8 text-center">Sign in to your vault server</div>
        <form onSubmit={submit} className="flex flex-col gap-3">
          ...
          <button disabled={busy} className="w-full flex items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm cursor-pointer bg-[var(--bg-hover)] text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)] disabled:opacity-40">
