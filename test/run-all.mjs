...
const SUITES = ['web-smoke', 'trash', 'theme-check', 'ai-debug', 'ai-chat-focus', 'ai-multiblock-follow', 'overlay-surface', 'overlay-surface-fallback', 'formatting-toolbar-compact', 'raw-markdown-highlight', 'mobile-shell-viewport']
const results = []
