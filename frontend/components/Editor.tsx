...
export default function Editor({ sidebarOpen, isDesktop, onToggleSidebar, onOpenSearch }: { sidebarOpen: boolean; isDesktop: boolean; onToggleSidebar: () => void; onOpenSearch: () => void }) {
    ...
    if (!onboardingDone && vaultOpen) {
      return (
        <div className="flex-1 flex flex-col min-w-0 min-h-0">
          <TabBar sidebarOpen={sidebarOpen} isDesktop={isDesktop} onToggleSidebar={onToggleSidebar} onOpenSearch={onOpenSearch} />
