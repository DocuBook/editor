...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            commands::vault::open_vault, commands::vault::close_vault, commands::vault::create_vault, commands::git::git_clone, commands::vault::list_tree, commands::vault::read_file, commands::vault::read_file_binary, commands::vault::write_file, commands::vault::create_file, commands::vault::delete_file, commands::vault::list_trash, commands::vault::restore_file, commands::vault::delete_trash_item, commands::vault::empty_trash, commands::vault::rename_file, commands::vault::create_directory,
            ...
            commands::git::git_remote_probe, commands::git::git_fetch, commands::git::git_remote_merge, commands::git::git_rebase, commands::git::git_rebase_continue, commands::git::git_rebase_abort, commands::git::git_merge_abort,
            commands::wiki::wiki_backlinks, commands::wiki::wiki_suggest, commands::wiki::wiki_resolve, commands::search::search_vault, commands::git::git_stage, commands::git::git_commit, commands::git::git_push_only, commands::git::git_branches, commands::git::git_create_branch, commands::git::git_checkout, commands::git::git_status,
